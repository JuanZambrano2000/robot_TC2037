...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    NOUN = 258,                    /* NOUN  */
    KINDWORD = 259,                /* KINDWORD  */
    KINDCOMPLEMENT = 260,          /* KINDCOMPLEMENT  */
    CN = 261,                      /* CN  */
    ADJ = 262,                     /* ADJ  */
    CONECTOR = 263,                /* CONECTOR  */
    MOVE = 264,                    /* MOVE  */
    TURN = 265,                    /* TURN  */
    DEGREE = 266,                  /* DEGREE  */
    NUM = 267,                     /* NUM  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_KINDWORD = 4,                   /* KINDWORD  */
  YYSYMBOL_KINDCOMPLEMENT = 5,             /* KINDCOMPLEMENT  */
  YYSYMBOL_CN = 6,                         /* CN  */
  YYSYMBOL_ADJ = 7,                        /* ADJ  */
  YYSYMBOL_CONECTOR = 8,                   /* CONECTOR  */
  YYSYMBOL_MOVE = 9,                       /* MOVE  */
  YYSYMBOL_TURN = 10,                      /* TURN  */
  YYSYMBOL_DEGREE = 11,                    /* DEGREE  */
  YYSYMBOL_NUM = 12,                       /* NUM  */
  YYSYMBOL_EOL = 13,                       /* EOL  */
